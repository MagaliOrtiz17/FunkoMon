# import face_recognition  # Comentado porque face_recognition requiere dlib
import numpy as np
from PIL import Image
import json

def generar_encoding_facial(foto_archivo):
    raise NotImplementedError("face_recognition no está instalado. Funcionalidad de biometría deshabilitada.")
    try:
